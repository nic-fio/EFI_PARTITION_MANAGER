/* Minimal UEFI definitions (UEFI Specification 2.10), written for EFI
 * Partition Manager from the specification. No EDK2 code. */
#ifndef PARTMGR_EFI_H
#define PARTMGR_EFI_H
