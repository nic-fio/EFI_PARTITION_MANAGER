...
#ifndef PARTMGR_PAL_H
#define PARTMGR_PAL_H
...
/* The program the platform layer starts (src/partmgr/main.c): app_main is
 * its portable entry point, app_name the name used in fatal-error messages
 * and as argv[0] when the firmware gives none. */
